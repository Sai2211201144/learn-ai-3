...
const ContinueLearningCard: React.FC<ContinueLearningCardProps> = ({ course, onSelectCourse, hasCourses, onNavigate }) => {
    ...
    return (
        <div className="bg-gradient-to-br from-[var(--color-primary)]/20 to-[var(--color-accent)]/20 p-6 rounded-2xl border border-[var(--color-border)] flex flex-col justify-between h-full">
            <div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 mt-6">
                ...
                {/* The "View All Courses" button is removed to simplify the component as this functionality is now handled by the main tabs. */}
            </div>
        </div>
    );
};
